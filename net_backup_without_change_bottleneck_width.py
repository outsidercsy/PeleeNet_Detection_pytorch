...
from layers import *
from data import voc, coco, icdar2015
...
class PeleeNet(nn.Module):
    def __init__(self, phase, num_classes=21):####
        ...
        ####stage1
        self.DenseBlock_1 = DenseBlock(nin=nin_transition_layer, num_dense_layers=num_dense_layers[0], growth_rate=growth_rate, drop_rate=0.0)
        ...
        ####stage2
        self.DenseBlock_2 = DenseBlock(nin=nin_transition_layer, num_dense_layers=num_dense_layers[1], growth_rate=growth_rate, drop_rate=0.0)
        ...
        ####stage3
        self.DenseBlock_3 = DenseBlock(nin=nin_transition_layer, num_dense_layers=num_dense_layers[2], growth_rate=growth_rate, drop_rate=0.0)
        ...
        ####stage4
        self.DenseBlock_4 = DenseBlock(nin=nin_transition_layer, num_dense_layers=num_dense_layers[3], growth_rate=growth_rate, drop_rate=0.0)
        ...
        for i in range(len(anchor_nums)):
            self.loc_layers += [nn.Conv2d(256, anchor_nums[i] * 4, kernel_size=3, padding=1, bias=False)]
            self.conf_layers += [nn.Conv2d(256, anchor_nums[i] * num_classes, kernel_size=3, padding=1, bias=False)]
    ...
    def forward(self, x):
        ...
        for (x, r, l, c) in zip(sources, self.ResBlocks, self.loc_layers, self.conf_layers):
            ...
            #     if str(type(module)) == "<class 'torch.nn.modules.batchnorm.BatchNorm2d'>":
            #         print('2 child module ________',module)########
            #         print('2 child module training is \n',module.training)########
            #     for module in module.children():#########
            #         if str(type(module)) == "<class 'torch.nn.modules.batchnorm.BatchNorm2d'>":
            #             print('3 child module ________',module)########
            #             print('3 child module training is \n',module.training)########
            # if self.phase == "test":
            #     r.eval()########
            x = r(x)
...
if __name__ == '__main__':
    p = PeleeNet(num_classes=21,phase='train')
